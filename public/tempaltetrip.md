...
export function generateLinehaulPretripPDF(input = {}) {
  const data = {
    tractor: "292446",
    destination: "03117 / QBTH",
    driver: "KING, BRANDON",
    tripDestination: "03117 / QBTH",
    eta: "May 16, 2026 23:06",
    timezone: "EDT",
    basedUpon: "May 16 2026 21: EDT DEPARTUR",
    facilityName: "BETHPAGE - HD - HOME DELIVERY",
    address: "700 HICKSVILLE ROAD",
    city: "BETHPAGE",
    state: "NY",
    zip: "11714",
    phone: "(516) 576-0170",
    ...
    avr: "1-888-867-1142",
    invoiceRef: "",
    gpsNorth: "40.742237 NORTH",
    gpsWest: "73.495514 WEST",
    originCode: "00089 / WOOD",
    originAddress: "6000 RIVERSIDE DR",
    originCity: "KEASBEY",
    originState: "NJ",
    originZip: "08832",
    originPhone: "(732) 512-5528",
    printedTime: "May 16 2026 23:55 EDT",
    trailers: [
      { number: "826740", seal: "", load: "BETHPAGE - HD - HOME", weight: "11701.88" },
      { number: "56452", seal: "", load: "BETHPAGE - HD - HOME", weight: "11125.78" },
      { number: "", seal: "", load: "N/A", weight: "N/A" },
    ],
    dollies: ["", ""],
    ...input,
  };
