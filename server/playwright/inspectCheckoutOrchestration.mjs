...
/** Post-click UI settle — kept bounded; main loop still re-probes screens. */
...
const SEAL_POLL_STEP_MS = 100
const DOLLY_POLL_MS = 125
const CHECKLIST_CHECKBOX_DELAY_MS = 60
