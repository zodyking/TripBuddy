 ...
 *
 * NOTE: This file is duplicated in server/directory-location-types.mjs for the production Docker
 * image (which only includes server/ + dist/, not src/). Keep both in sync if you change the logic.
 */
